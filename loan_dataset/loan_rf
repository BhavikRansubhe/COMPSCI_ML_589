...
# Load loan dataset
loan_df = pd.read_csv("loan.csv")  # Adjust the path as per your dataset location

# Drop irrelevant columns
columns_to_drop = ['Loan_ID']  # Example columns to drop
...
for col in categorical_columns:
    ...
    loan_df[col] = label_encoders[col].fit_transform(loan_df[col])
